...
class RequestType(IntEnum):
    ...
    FEATURE_STORE_MANAGER_OPEN   = 0b0000_0101
    FEATURE_STORE_MANAGER_LIST   = 0b0000_0110
    FEATURE_STORE_MANAGER_CREATE = 0b0000_0111
    FEATURE_STORE_MANAGER_REMOVE = 0b0000_1000

    # FEATURE STORE
    FEATURE_STORE_CONTAINS         = 0b0000_1001
    FEATURE_STORE_INSERT_TENSOR    = 0b0000_1010
    FEATURE_STORE_REMOVE_TENSOR    = 0b0000_1011
    FEATURE_STORE_GET_TENSOR       = 0b0000_1100
    FEATURE_STORE_MULTI_GET_TENSOR = 0b0000_1101
    FEATURE_STORE_SIZE             = 0b0000_1110
    FEATURE_STORE_CLOSE            = 0b0000_1111

    # NODE ITERATOR
    NODE_ITERATOR_NEW   = 0b0001_0000
    NODE_ITERATOR_BEGIN = 0b0001_0001
    NODE_ITERATOR_NEXT  = 0b0001_0010
    NODE_ITERATOR_CLOSE = 0b0001_0011
