...
class RequestType(IntEnum):
    ...
    FEATURE_STORE_MULTI_INSERT_TENSOR = 0b0000_1100
    FEATURE_STORE_REMOVE_TENSOR       = 0b0000_1101
    FEATURE_STORE_GET_TENSOR          = 0b0000_1110
    FEATURE_STORE_MULTI_GET_TENSOR    = 0b0000_1111
    FEATURE_STORE_SIZE                = 0b0001_0000
    FEATURE_STORE_CLOSE               = 0b0001_0001

    # SAMPLER
    SAMPLER_GET_SEED_IDS = 0b0001_0010
